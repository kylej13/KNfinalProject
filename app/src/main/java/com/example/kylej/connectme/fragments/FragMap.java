package com.example.kylej.connectme.fragments;
...
import com.example.kylej.connectme.MainActivity;
import com.example.kylej.connectme.R;
 ...
 */
public class FragMap extends MapFragment{
    ...
    GoogleMap theMap;
    MapFragment frag;
    LatLng Blacksburg = new LatLng(37.2300, 80.4178);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(Blacksburg).zoom(12).build();
